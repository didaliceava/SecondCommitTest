...
public class ConstructorBasic {
    ...
    */
	ConstructorBasic(){ // user defined constructor // same name as class
	...
	public static void main(String[] args) {
		...
		ConstructorBasic obj= new ConstructorBasic();  // the name "Obj" is the reference is not the  actual object , the object is New Constructor
